...
#else
void llama_kv_cache::set_input_kq_mask(ggml_tensor * dst, const llama_ubatch * ubatch, bool causal_attn, ggml_flash_attn_mask_params * out_info) const {
#endif
    #ifdef GGML_USE_DLFA
    const uint32_t n_tokens = ubatch->real_n_tokens;
    #else
...
#else
void llama_kv_cache_context::set_input_kq_mask(ggml_tensor * dst, const llama_ubatch * ubatch, bool causal_attn, ggml_flash_attn_mask_params * out_info) const {
    kv->set_input_kq_mask(dst, ubatch, causal_attn, out_info);
}
#endif
