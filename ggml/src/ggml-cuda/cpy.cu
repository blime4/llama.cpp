...
static void ggml_cpy_f16_f32_cuda(
    ...
    const int64_t max_int32 = ((int64_t)1 << 31) - 1; // 0x7FFFFFFF

    if (!(ne & ~max_int32) ) {
        cpy_f32_f16_small<cpy_1_f16_f32><<<num_blocks, CUDA_CPY_BLOCK_SIZE, 0, stream>>>
...
static void ggml_cpy_f32_f32_cuda(
    ...
    if (!(ne & ~max_int32)) {
        cpy_f32_f16_small<cpy_1_f32_f32><<<num_blocks, CUDA_CPY_BLOCK_SIZE, 0, stream>>>
        (cx, cdst, ne, ne00, ne01, ne02, nb00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb13, cdst_indirect, graph_cpynode_index++);
        return;
    }
...
static void ggml_cpy_f32_f16_cuda(
    ...
    if (!(ne & ~max_int32)) {
        cpy_f32_f16_small<cpy_1_f32_f16><<<num_blocks, CUDA_CPY_BLOCK_SIZE, 0, stream>>>
        (cx, cdst, ne, ne00, ne01, ne02, nb00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb13, cdst_indirect, graph_cpynode_index++);
        return;
    }
...
static void ggml_cpy_f16_f16_cuda(
    ...
    if (!(ne & ~max_int32)) {
        cpy_f32_f16_small<cpy_1_f16_f16><<<num_blocks, CUDA_CPY_BLOCK_SIZE, 0, stream>>>
        (cx, cdst, ne, ne00, ne01, ne02, nb00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb13, cdst_indirect, graph_cpynode_index++);
        return;
    }
