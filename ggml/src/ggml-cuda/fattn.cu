...
#if defined(GGML_USE_DLFA)
    if (ggml_dl::flash_attn_dldnn_available(dst)) {
        return BEST_FATTN_KERNEL_DLFA;
    }
    GGML_LOG_WARN("DLDNN is not available, using fallback implementation.\n");
#endif
