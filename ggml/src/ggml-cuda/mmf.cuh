...
#if (!defined(GGML_USE_HIP) && !defined(GGML_USE_MUSA)) && !defined(GGML_USE_DLCU) || defined(AMD_WMMA_AVAILABLE)
...
#pragma unroll
    ...
    NO_DEVICE_CODE;
#endif // (!defined(GGML_USE_HIP) && !defined(GGML_USE_MUSA)) && !defined(GGML_USE_DLCU) || defined(AMD_WMMA_AVAILABLE)
}
