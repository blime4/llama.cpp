...
#define GGML_N_TASKS_MAX (-1)
    ...
    #ifdef GGML_USE_DLFA
    GGML_API void                  ggml_graph_set_n_tokens(struct ggml_cgraph * cgraph, int n_tokens);
    GGML_API void                  ggml_graph_set_flash_attn(struct ggml_cgraph * cgraph, bool status);
    #endif
